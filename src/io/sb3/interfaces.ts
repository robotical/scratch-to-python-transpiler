...
export const fieldTypeMap: {
  ...
  // Looks
  [OpCode.mv2_discoChangeBlockPattern]: {BOARDTYPE: "list"},
  ...
  [OpCode.mv2_discoChangeRegionColour]: {REGION: "list"},
  ...
  [OpCode.mv2_coloursenseraw]: {SENSORCHOICE: "list"},
  [OpCode.mv2_lightsense]: {SENSORCHOICE: "list"},
