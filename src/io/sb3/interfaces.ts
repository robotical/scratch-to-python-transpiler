...
export const fieldTypeMap: {
  ...
  // **** MARTY ****
  // Motion
  [OpCode.mv2_circle]: { SIDE: "list" },
  [OpCode.mv2_eyes]: { COMMAND: "list" },
  [OpCode.mv2_kick]: { SIDE: "list" },
  [OpCode.mv2_lean]: { SIDE: "list" },
  [OpCode.mv2_liftFoot]: { SIDE: "list" },
  [OpCode.mv2_lowerFoot]: { SIDE: "list" },
  [OpCode.mv2_moveJoint]: { SERVOCHOICE: "list" },
  [OpCode.mv2_moveLeg]: { SIDE: "list", DIRECTION: "list" },
  [OpCode.mv2_slide]: { SIDE: "list" },
  [OpCode.mv2_slideMsLength]: { SIDE: "list" },
  [OpCode.mv2_turn]: { SIDE: "list" },
  [OpCode.mv2_wave]: { SIDE: "list" },
  [OpCode.mv2_stop]: { STOP_TYPE: "list" },
  [OpCode.mv2_gripperArmBasic]: { HAND_POSITION: "list" },
  [OpCode.mv2_gripperArmTimed]: { HAND_POSITION: "list" },
  // Looks
  [OpCode.mv2_discoChangeBlockPattern]: { BOARDTYPE: "list", PATTERN: "list" },
  [OpCode.mv2_LEDEyesColour]: { BOARDTYPE: "list" },
  [OpCode.mv2_LEDEyesColour_SpecificLED]: { BOARDTYPE: "list" },
  [OpCode.colour_picker_LED_eyes]: { COLOUR: "list" },
  [OpCode.mv2_LEDEyesColourLEDs]: { SIDE: "list" },
  [OpCode.mv2_discoChangeRegionColour]: { BOARDTYPE: "list", REGION: "list" },
  [OpCode.mv2_playNote]: { NOTES_MENU: "list" },
  [OpCode.mv2_changePitchEffect]: { EFFECT: "list" },
  [OpCode.mv2_setPitchEffect]: { EFFECT: "list" },
  // Sensing
  [OpCode.ServoCurrent]: { SERVOCHOICE: "list" },
  [OpCode.ServoPosition]: { SERVOCHOICE: "list" },
  [OpCode.mv2_obstaclesense]: { SENSORCHOICE: "list" },
  [OpCode.mv2_groundsense]: { SENSORCHOICE: "list" },
  [OpCode.mv2_coloursense]: { SENSORCHOICE: "list" },
  [OpCode.mv2_coloursense_hex]: { SENSORCHOICE: "list" },
  [OpCode.mv2_coloursenseraw]: { SENSORCHOICE: "list", SENSORCHANNEL: "list" },
  [OpCode.mv2_lightsense]: { SENSORCHOICE: "list", SENSORCHANNEL: "list" },
  [OpCode.mv2_noisesense]: { SENSORCHOICE: "list" },
  [OpCode.mv2_onObjectSense]: { SENSORCHOICE: "list" },
  [OpCode.mv2_onColourSense]: { COLOUR: "list" },
